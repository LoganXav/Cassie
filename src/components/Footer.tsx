    ...
    <div className="footer-container">
      <div className="footer">
        <div className="images">
          ...
          <div className="img-container">
            <img src="https://media.istockphoto.com/id/1460105832/photo/woman-legs-and-beauty-in-studio-for-skin-grooming-and-hygiene-treatment-against-grey-a.jpg?b=1&s=170667a&w=0&k=20&c=Ry9643tfNDiEsU3WknkcVgs7V7tyyTiKaC3RmE_QueA=" />
          </div>
        </div>
